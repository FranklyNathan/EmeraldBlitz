...
extern const u8 gText_FourthWeather[];
...
extern const u8 gText_FlyHintBerries[];
extern const u8 gText_FlyHintBriney[];
extern const u8 gText_FlyHintNewBerries[];
extern const u8 gText_FlyHintDaycare[];
extern const u8 gText_FlyHintItems[];
extern const u8 gText_FlyHintGuru[];
extern const u8 gText_FlyHintEvoItems[];
extern const u8 gText_FlyHintOracle[];
extern const u8 gText_FlyHintRelearner[];
extern const u8 gText_FlyHintRelearnerPlus[];
extern const u8 gText_FlyHintLinkCable[];
extern const u8 gText_FlyHintMegaStones[];
extern const u8 gText_FlyHintEliteFour[];
extern const u8 gText_FlyHintFirstGym[];
extern const u8 gText_FlyHintSecondGym[];
extern const u8 gText_FlyHintThirdGym[];
extern const u8 gText_FlyHintFourthGym[];
extern const u8 gText_FlyHintFifthGym[];
extern const u8 gText_FlyHintSixthGym[];
extern const u8 gText_FlyHintSeventhGym[];
extern const u8 gText_FlyHintEighthGym[];
...
extern const u8 gText_MenuLair[];
...
extern const u8 gText_Evo[];
extern const u8 gText_NoEvolution[];
