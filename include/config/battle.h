...
#define B_PARALYSIS_CHANCE          GEN_LATEST // Gen9+: paralysis has 12.5% chance of not moving, instead of 25%.
...
#define B_FREEZE_TURNS              GEN_LATEST // Prior to Gen9, 20% thaw chance. Gen9+: 25% with 3-turn hard cap.
