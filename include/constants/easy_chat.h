...
#define EASY_CHAT_TYPE_SOOTOPOLIS_FALL         21
#define EASY_CHAT_TYPE_SOOTOPOLIS_FALL_2       22
...
#define EC_WORD_EXTREMELY     ((EC_GROUP_CONDITIONS << EC_MASK_BITS) | 69)
#define EC_WORD_UNSPEAKABLY   ((EC_GROUP_CONDITIONS << EC_MASK_BITS) | 70)
