...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_RAINCONTINUES]                        = COMPOUND_STRING("Rain continues to fall for the {B_BUFF1} turn."), //not in gen 5+
    [STRINGID_DOWNPOURCONTINUES]                    = COMPOUND_STRING("The downpour continues for the {B_BUFF1} turn."), // unused
    [STRINGID_RAINSTOPPED]                          = COMPOUND_STRING("The rain stopped."),
    [STRINGID_SANDSTORMBREWED]                      = COMPOUND_STRING("A sandstorm kicked up!"),
    [STRINGID_SANDSTORMRAGES]                       = COMPOUND_STRING("The sandstorm is raging for the {B_BUFF1} turn."),
    ...
    [STRINGID_SUNLIGHTSTRONG]                       = COMPOUND_STRING("The sunlight is strong for the {B_BUFF1} turn."), //not in gen 5+
    [STRINGID_SUNLIGHTFADED]                        = COMPOUND_STRING("The sunlight faded."),
    [STRINGID_STARTEDHAIL]                          = COMPOUND_STRING("It started to hail!"),
    [STRINGID_HAILCONTINUES]                        = COMPOUND_STRING("The hail is crashing down for the {B_BUFF1} turn."),
    ...
    [STRINGID_MYSTERIOUSAIRCURRENTBLOWSON]          = COMPOUND_STRING("The mysterious strong winds blow on for the {B_BUFF1} turn!"),
    ...
    [STRINGID_SNOWCONTINUES]                        = COMPOUND_STRING("Snow continues to fall for the {B_BUFF1} turn."), //not in gen 5+ (lol)
    ...
    [STRINGID_FOGISDEEP]                            = COMPOUND_STRING("The fog is deep for the {B_BUFF1} turn…"),
    ...
    [STRINGID_THUNDERSTORMRAGES]                    = COMPOUND_STRING("The thunderstorm is raging for the {B_BUFF1} turn!"),
