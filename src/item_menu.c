...
static const u8 sContextMenuItems_BerriesPocket[] = {
    ACTION_GIVE_ALL,    ACTION_CHECK_TAG,
...
static void MergeSort(struct BagPocket *pocket, s32 (*comparator)(enum Pocket, struct ItemSlot, struct ItemSlot))
{
    ...
    // Include any gaps left behind by removed items so that they get sorted
    // to the end of the used range (compacting the pocket)
    u32 usedCapacity = 0;
