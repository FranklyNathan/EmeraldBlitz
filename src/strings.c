...
const u8 gText_LeagueChamp[] = _("BLITZ v1.0.16 CHAMPION!\nCONGRATULATIONS!");
const u8 gText_LeagueChampNTS[] = _("BLITZ CHAMPION!\nCONGRATULATIONS!");
const u8 gText_LeagueChampFB[] = _(" BLITZ CHAMPION!\nCONGRATULATIONS!");
const u8 gText_TooScaredForRace[] = _("I, moo807, lack the gumption\nto join a community race!");
...
const u8 gText_FlyHintBerries[] = _("Berries Available!");
const u8 gText_FlyHintBriney[] = _("Briney Available!");
const u8 gText_FlyHintNewBerries[] = _("New Berries Available!");
const u8 gText_FlyHintDaycare[] = _("Day Care Available!");
const u8 gText_FlyHintItems[] = _("Items Available!");
const u8 gText_FlyHintGuru[] = _("Guru Available!");
const u8 gText_FlyHintEvoItems[] = _("Evo Items Available!");
const u8 gText_FlyHintOracle[] = _("Oracle Available!");
const u8 gText_FlyHintRelearner[] = _("Relearner Available!");
const u8 gText_FlyHintRelearnerPlus[] = _("Relearner+ Available!");
const u8 gText_FlyHintFirstGym[] = _("First Gym Unlocked!");
const u8 gText_FlyHintSecondGym[] = _("Second Gym Unlocked!");
const u8 gText_FlyHintThirdGym[] = _("Third Gym Unlocked!");
const u8 gText_FlyHintFourthGym[] = _("Fourth Gym Unlocked!");
const u8 gText_FlyHintFifthGym[] = _("Fifth Gym Unlocked!");
const u8 gText_FlyHintSixthGym[] = _("Sixth Gym Unlocked!");
const u8 gText_FlyHintLinkCable[] = _("L. Cable Available!");
const u8 gText_FlyHintMegaStones[] = _("M. Stones Available!");
const u8 gText_FlyHintSeventhGym[] = _("Seventh Gym Unlocked!");
const u8 gText_FlyHintEighthGym[] = _("Eighth Gym Unlocked!");
const u8 gText_FlyHintEliteFour[] = _("Elite Four Unlocked!");
...
const u8 gText_Reroll[] = _("REROLL");
const u8 gText_Invert[] = _("INVERT");
const u8 gText_RerollDescription[] = _("Roll a new set of\nTMs for sale.");
const u8 gText_InvertDescription[] = _("Swap TMs with same-\ntype counterparts.\nUse {SELECT_BUTTON}{CLEAR 0x02}to preview.");
...
const u8 gText_Purchased[] = _("SOLD");
...
const u8 gText_FindWordsThatDescribeYour[] = _("How embarrassed do you feel");
const u8 gText_FeelingsRightNow[] = _("right now?");
...
const u8 gText_MenuLair[] = _("LAIR");
