...
const u8 gText_LeagueChamp[] = _("BLITZ v1.0.5 CHAMPION!\nCONGRATULATIONS!");
const u8 gText_LeagueChampNTS[] = _("BLITZ v1.0.5  CHAMPION!\nCONGRATULATIONS!");
const u8 gText_LeagueChampFB[] = _(" BLITZ v1.0.5 CHAMPION!\nCONGRATULATIONS!");
